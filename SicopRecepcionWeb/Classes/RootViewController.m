...
@synthesize titulo;
@synthesize  tvCell;
//@synthesize  TipoMensajesMostrar;
...
- (void)viewDidLoad {
   ...
   [super viewDidLoad];
    ...
    [[NSUserDefaults standardUserDefaults] setObject:@"RootViewController" forKey:kAppValorPantallaActual];
...
#pragma mark-
#pragma mark manejo del evento de carga de datos
...
-(void) cargarEncabezadosEnDelegate{
   /*
    [appDelegate cargarResumenMsj:self.TipoMensajesMostrar];
...
-(void) checarStatusCargaEncabezados:(NSNotification *)notice{
   
}

#pragma mark -
#pragma mark Rutina para validar cuando el Viecontroller se activa nuevamente
